...
fun ChatItem(
    ...
    OutlinedCard(
        modifier = modifier
            .let {
                if (longPressEnable) it.combinedClickable(onLongClickLabel = stringResource(R.string.delete),
                    onLongClick = {
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = if (model.senderUid == uid) "Me" else model.senderName,
